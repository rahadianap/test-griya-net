    ...
    <div>
        ...
        <Modal :show="openingModal" @close="closeModal" :isUpdate=false>
            <div class="p-6">
                ...
                <div class="mt-6">
                    <InputLabel for="nama_paket" value="Nama Paket" />

                    <TextInput
                        type="text"
                        class="mt-1 block w-full"
                        v-model="packages.nama_paket"
                        required
                        autofocus
                    />
                ...
                <div class="mt-6">
                    <InputLabel for="harga_paket" value="Harga Paket" />

                    <NumberInput
                        type="number"
                        class="mt-1 block w-full"
                        v-model="packages.harga_paket"
                        required
                        autofocus
                    />

                    <InputError class="mt-2" :message="form.errors.harga_paket" />
                </div>
                                    ...
                                    <table class="min-w-full border divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            <th class="bg-gray-50 px-6 py-3 text-left">
                                                <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">Nama Paket</span>
                                            </th>
                                            <th class="bg-gray-50 px-6 py-3 text-left">
                                                <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">Harga Paket</span>
                                            </th>
...
export default {
    ...
    data() {
        return {
            'url': 'http://localhost:8000/api/paket-penjualan',
            'packages': {
                'id': '',
                'nama_paket': '',
                'harga_paket': 0,
    ...
    methods: {
        openModal() {
            ...
            this.packages.nama_paket = '';
            this.packages.harga_paket = 0;
            this.isUpdate = false;
        },
        ...
        openModalEdit(item) {
            ...
            this.packages.nama_paket = item.nama_paket;
            this.packages.harga_paket = item.harga_paket;
            this.isUpdate = true;
        },
        ...
        async storeData() {
            ...
            formData.append('nama_paket', this.packages.nama_paket);
            formData.append('harga_paket', this.packages.harga_paket);
